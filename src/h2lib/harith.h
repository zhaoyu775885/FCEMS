...
add_amatrix_rkmatrix(field alpha, bool atrans, pcamatrix a,
		     pctruncmode tm, double eps, prkmatrix b);
 ...
 *  @param b Target @ref hmatrix @f$B@f$. */
void
add_rkmatrix_hmatrix(field alpha, pcrkmatrix a, pctruncmode tm, double eps,
    phmatrix b);
...
triangularinvmul_amatrix_hmatrix(bool alower, bool aunit, bool atrans,
    pcamatrix a, pctruncmode tm, double eps, bool xtrans, phmatrix xp);
